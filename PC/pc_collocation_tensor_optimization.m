...
for i = 1:n_b
    [x,training_err(i),test_err(i),n_iterations(i)] = f(training_samples,training_out(:,i),x,r_max,5e-3,max_iteration,test_samples,test_out(:,i),lambda2);
